...
public static class PetDockPresentation
{
    ...
    {
        PetDockEdge.Top => new(PetSpriteKind.Top, false, 170, 108, TimeSpan.Zero),
        PetDockEdge.Bottom => new(PetSpriteKind.Bottom, false, 180, 125, TimeSpan.Zero),
        PetDockEdge.Left => new(PetSpriteKind.Side, false, 92, 175, TimeSpan.Zero),
        PetDockEdge.Right => new(PetSpriteKind.Side, true, 92, 175, TimeSpan.Zero),
